...
public class RegistrationIncompleteValidation implements Question<String> {
    ...
    public static RegistrationIncompleteValidation successful(){
        return new RegistrationIncompleteValidation();
    }
}
